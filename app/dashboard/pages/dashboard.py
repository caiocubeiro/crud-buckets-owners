...
from app.dashboard.functions.util import (
    atualizaFiltros,
    montaBarChartBuckets,
    montaBarChartSize,
    montaPieChartBuckets,
    montaPieChartSize,
)
...
def update_data(owner_name, owner_department):
    ...
    num_var_preenchidas = sum(
        1
        for valor in filtro_dict.values()
    ...
    return (
        ...
        figChartSize,
        figPieSize,
        opcoes_filtros["owner_name"],
        opcoes_filtros["owner_department"],
    )
